    ...
    public void onReceive(Context context, Intent intent){
      if (Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())) {
        ...
        if (intent.getIntExtra("plugged", -1) == 0) {
            com.karthikb351.vitinfo2.objects.BarCodeScanner.InactivityTimer.this.onActivity();
        } else {
            com.karthikb351.vitinfo2.objects.BarCodeScanner.InactivityTimer.this.cancel();
        }
      }
    }
  }

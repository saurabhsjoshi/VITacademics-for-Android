...
public class TimeTable{
    ...
    public boolean getFriendStatus(AddFriendResponse addFriendResponse){
        Timetable timetable = addFriendResponse.getData().getTimetable();
        ...
        if(Day == Calendar.SATURDAY || Day == Calendar.SUNDAY)
        {
            ...
            try {
                ...
                List<Integer> slots = timetable.getTimeTableforDay(dayFormat.format(calendar.getTime()));
                String clsnbr, slt="";
                ...
                for(int i = 0; i < slots.size(); i++){
                    if(slots.get(i) != 0){
                        ...
                        Course course = addFriendResponse.getData().getCourse(clsnbr);

package com.karthikb351.vitinfo2.old.activity;
...
public class MainActivityOld extends Activity {
    ...
    {
        Toast.makeText(MainActivityOld.this, "Reg:"+event.getLoginResponse().getRegno()+" Status:"+event.getLoginResponse().getStatus().getMessage(), Toast.LENGTH_SHORT).show();
    }
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        return getSharedPreferences(MainActivityOld.class.getSimpleName(), Context.MODE_PRIVATE);
    }
